...
export const DESKTOP_NATIVE_ENGLISH = {
  "desktop.menu.app": "Melange Agent",
  ...
  "desktop.recovery.loadFailed": "Melange Agent failed to load",
  "desktop.recovery.terminated": "Melange Agent window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Melange Agent is not responding",
