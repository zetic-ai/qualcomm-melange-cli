    ...
    items: [
      {
        ...
        href: "https://github.com/zetic-ai/qualcomm-melange-cli",
      },
      {
        type: "item",
        labelKey: "desktop.menu.supportForum",
        href: "https://github.com/zetic-ai/qualcomm-melange-cli/issues",
      },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        ...
        href: "https://github.com/zetic-ai/qualcomm-melange-cli/issues/new",
      },
      {
        type: "item",
