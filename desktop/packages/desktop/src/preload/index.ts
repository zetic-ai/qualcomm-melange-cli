...
const api: ElectronAPI = {
  ...
  melangeAuth: {
    status: () => ipcRenderer.invoke("melange-auth-status"),
    loginBrowser: () => ipcRenderer.invoke("melange-auth-login-browser"),
    loginToken: (token) => ipcRenderer.invoke("melange-auth-login-token", token),
    cancelLogin: () => ipcRenderer.invoke("melange-auth-cancel-login"),
    logout: () => ipcRenderer.invoke("melange-auth-logout"),
  },
