export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Melange Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Melange Agent has been downloaded, would you like to install it and relaunch?",
