...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  const bundledSkills = process.env.MELANGE_AGENT_SKILLS_DIR
  if (bundledSkills && (yield* fsys.isDir(bundledSkills))) {
    yield* scan(state, bundledSkills, SKILL_PATTERN, { scope: "Melange Agent" })
  }
